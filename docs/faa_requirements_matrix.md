...
| Weather source and interpolation | provider metadata, cycle/valid time, variables, checksums | SUPPORTED | HRRR, GEFS, and credential-gated ERA5 retrieval implemented; planner integration remains unvalidated |
...
| Terrain | provider, resolution, datum, interpolation, checksum | SUPPORTED | 3DEP network sampling is implemented; engineering validation remains required |
